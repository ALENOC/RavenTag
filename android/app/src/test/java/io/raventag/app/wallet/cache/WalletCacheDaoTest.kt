...
class WalletCacheDaoTest {
    ...
    fun balance_subtracts_reserved_never_negative() {
        val utxos = listOf(Utxo(txid = "a", outputIndex = 0, satoshis = 300_000_000L, script = "76a914000000000000000000000000000000000000000088ac", height = 100))
    ...
    fun balance_subtracts_reserved_positive() {
        val utxos = listOf(
            Utxo(txid = "a", outputIndex = 0, satoshis = 500_000_000L, script = "76a914000000000000000000000000000000000000000088ac", height = 100),
            Utxo(txid = "b", outputIndex = 0, satoshis = 300_000_000L, script = "76a914000000000000000000000000000000000000000088ac", height = 100),
            Utxo(txid = "c", outputIndex = 0, satoshis = 200_000_000L, script = "76a914000000000000000000000000000000000000000088ac", height = 100)
        )
    ...
    fun roundtrip_preserves_utxos_and_timestamp() {
        // Stub: real implementation in plan 30-02
